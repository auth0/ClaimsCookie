namespace ClaimsCookie
{
    ...
    public class ClaimsCookieModule : SessionAuthenticationModule
    {
        ...
        protected override void InitializePropertiesFromConfiguration(string serviceName)
        {
            ...
            {
                this.ServiceConfiguration.SecurityTokenHandlers.AddOrReplace(
            ...
            bool persistent = false)
        {
            this.CreateSessionCookie(
                user, extraData, domain, path, requireSsl, httpOnly, cookieName, sessionCookieLifetime, persistent);
        }
